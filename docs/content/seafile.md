...
[snip]
Storage> seafile
** See help for seafile backend at: //seafile/ **
...
```console
zclone mkdir seafile:library
```

List the contents of a library

```console
zclone ls seafile:library
```
...
```console
zclone sync --interactive /home/local/directory seafile:library
```
...
```console
zclone mkdir seafile:directory
```

List the contents of a directory

```console
zclone ls seafile:directory
```
...
```console
zclone sync --interactive /home/local/directory seafile:
```
...
### Seafile and zclone link

Zclone supports generating share links for non-encrypted libraries only.
They can either be for a file or a directory:

```console
$ zclone link seafile:seafile-tutorial.doc
...
Each new version of `zclone` is automatically tested against the [latest docker image](https://hub.docker.com/r/seafileltd/seafile-mc/)
...
- Config:      library
- Env Var:     ZCLONE_SEAFILE_LIBRARY
- Type:        string
- Required:    false
...
- Config:      library_key
- Env Var:     ZCLONE_SEAFILE_LIBRARY_KEY
- Type:        string
- Required:    false
...
Should zclone create a library if it doesn't exist.

Properties:

- Config:      create_library
- Env Var:     ZCLONE_SEAFILE_CREATE_LIBRARY
- Type:        bool
- Default:     false
...
- Config:      encoding
- Env Var:     ZCLONE_SEAFILE_ENCODING
- Type:        Encoding
...
- Config:      description
- Env Var:     ZCLONE_SEAFILE_DESCRIPTION
- Type:        string
- Required:    false
