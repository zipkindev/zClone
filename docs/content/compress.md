...
but they have some hidden metadata that allows them to be used by zclone.
...
names should not be changed by anything other than the zclone compression backend.
...
- Config:      remote
- Env Var:     ZCLONE_COMPRESS_REMOTE
- Type:        string
- Required:    true
...
- Env Var:     ZCLONE_COMPRESS_RAM_CACHE_LIMIT
- Type:        SizeSuffix
- Default:     20Mi
...
- Config:      description
- Env Var:     ZCLONE_COMPRESS_DESCRIPTION
- Type:        string
- Required:    false
