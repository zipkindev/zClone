---
title: "Files.com"
description: "Zclone docs for Files.com"
...
Zclone currently only support CRC32 and MD5 for use in syncing but
selecting more checksums will not affect zclone's operations.

For use with zclone, selecting at least MD5 is recommended so zclone
...
- Config:      username
- Env Var:     ZCLONE_FILESCOM_USERNAME
- Type:        string
- Required:    false
...
- Config:      password
- Env Var:     ZCLONE_FILESCOM_PASSWORD
- Type:        string
- Required:    false
...
- Config:      api_key
- Env Var:     ZCLONE_FILESCOM_API_KEY
- Type:        string
- Required:    false
...
- Config:      encoding
- Env Var:     ZCLONE_FILESCOM_ENCODING
- Type:        Encoding
...
- Config:      description
- Env Var:     ZCLONE_FILESCOM_DESCRIPTION
- Type:        string
- Required:    false
