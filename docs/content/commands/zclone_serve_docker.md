...
```
      ...
      --base-dir string                        Base directory for volumes (default "/var/lib/docker-volumes/zclone")
  ...
  -o, --option stringArray                     Option for libfuse/WinFsp (repeat if required)
      ...
      --read-only                              Only allow read-only access
      --socket-addr string                     Address <host:port> or absolute path (default: /run/docker/plugins/zclone.sock)
