---
title: "zclone"
description: "Show help for zclone commands, flags and backends."
# autogenerated - DO NOT EDIT, instead edit the source code in cmd/ and as part of making a release run "make commanddocs"
---
# zclone

Show help for zclone commands, flags and backends.

## Synopsis

zclone syncs files to and from cloud storage providers as well as
mounting them, listing them in lots of different ways.

Run zclone help <command> for command-specific documentation.
...
```
      ...
      --box-root-folder-id string                           Fill in for zclone to use a non root folder as its starting point
      ...
      --cache-chunk-path string                             Directory to cache chunk files (default "/var/folders/8n/pnkwx54j56l_j6l3zx2bqdb40000gp/T/tmp.Ix3gnniayL/Library/Caches/zclone/cache-backend")
      ...
      --cache-db-path string                                Directory to store file structure metadata DB (default "/var/folders/8n/pnkwx54j56l_j6l3zx2bqdb40000gp/T/tmp.Ix3gnniayL/Library/Caches/zclone/cache-backend")
      --cache-db-purge                                      Clear all the cached data for this remote on start
      --cache-db-wait-time Duration                         How long to wait for the DB to be available - 0 is unlimited (default 1s)
      --cache-description string                            Description of the remote
      --cache-dir string                                    Directory zclone will use for caching (default "/var/folders/8n/pnkwx54j56l_j6l3zx2bqdb40000gp/T/tmp.Ix3gnniayL/Library/Caches/zclone")
  ...
  -c, --checksum                                            Check for changes with size & checksum (if available, or fallback to size only)
      ...
      --config string                                       Config file (default "/var/folders/8n/pnkwx54j56l_j6l3zx2bqdb40000gp/T/tmp.Ix3gnniayL/.config/zclone/zclone.conf")
  ...
  -L, --copy-links                                          Follow symlinks and copy the pointed to item
      ...
      --drive-scope string                                  Comma separated list of scopes that zclone should use when requesting access from drive
      ...
      --dropbox-shared-files                                Instructs zclone to work on individual shared files
      --dropbox-shared-folders                              Instructs zclone to work on shared folders
      --dropbox-show-all-exports                            Show all exportable files in listings
      --dropbox-skip-exports                                Skip exportable files in all listings
      --dropbox-skip-shared-folders                         Instructs zclone to skip all shared folders
      --dropbox-skip-unowned-folders                        Instructs zclone to skip shared folders not owned by the current user
  ...
  -n, --dry-run                                             Do a trial run with no permanent changes
      ...
      --filelu-key string                                   Your FileLu Zclone key from My Account
  ...
  -f, --filter stringArray                                  Add a file filtering rule
      ...
      --ftp-user string                                     FTP username (default "mizipkin")
  ...
  -h, --help                                                help for zclone
      ...
      --hidrive-scope-access string                         Access permissions that zclone should use when requesting access from HiDrive (default "rw")
      --hidrive-scope-role string                           User-level that zclone should use when requesting access from HiDrive (default "user")
  ...
  -i, --interactive                                         Enable interactive mode
      ...
      --internetarchive-disable-checksum                    Don't ask the server to test against MD5 checksum calculated by zclone (default true)
      ...
      --koofr-password string                               Your password for zclone generate one at https://app.koofr.net/app/admin/preferences/password (obscured)
  ...
  -l, --links                                               Translate symlinks to/from regular files with a '.zclonelink' extension
      ...
      --local-links                                         Translate symlinks to/from regular files with a '.zclonelink' extension for the local backend
      ...
      --max-duration Duration                               Maximum duration zclone will transfer data for (default 0s)
  ...
  -M, --metadata                                            If set, preserve metadata when copying objects
      ...
      --metrics-min-tls-version string                      Minimum TLS version that is acceptable (default "tls1.2")
  ...
  -x, --one-file-system                                     Don't cross filesystem boundaries (unix/macOS only)
      --onedrive-access-scopes SpaceSepList                 Set scopes to be requested by zclone (default Files.Read Files.ReadWrite Files.Read.All Files.ReadWrite.All Sites.Read.All offline_access)
      ...
      --onedrive-delta                                      If set zclone will use delta listing to implement recursive listings
      ...
      --pcloud-root-folder-id string                        Fill in for zclone to use a non root folder as its starting point (default "d0")
  ...
  -q, --quiet                                               Print as little stuff as possible
      ...
      --s3-sign-accept-encoding Tristate                    Set if zclone should include Accept-Encoding as part of the signature (default unset)
      ...
      --s3-use-already-exists Tristate                      Set if zclone should report BucketAlreadyExists errors on bucket creation (default unset)
      ...
      --s3-use-multipart-uploads Tristate                   Set if zclone should use multipart uploads (default unset)
      ...
      --s3-use-x-id Tristate                                Set if zclone should add x-id URL parameters (default unset)
      ...
      --seafile-create-library                              Should zclone create a library if it doesn't exist
      ...
      --sftp-user string                                    SSH username (default "mizipkin")
      ...
      --shade-drive-id string                               The ID of your drive, see this in the drive settings. Individual zclone configs must be made per drive
      ...
      --shade-token string                                  JWT Token for performing Shade FS operations. Don't set this value - zclone will set it automatically
      --shade-token-expiry string                           JWT Token Expiration time. Don't set this value - zclone will set it automatically
      ...
      --smb-user string                                     SMB username (default "mizipkin")
      ...
      --temp-dir string                                     Directory zclone will use for temporary files (default "/var/folders/8n/pnkwx54j56l_j6l3zx2bqdb40000gp/T/")
      ...
      --ulozto-root-folder-slug string                      If set, zclone will use this folder as the root folder for all operations. For example,
  ...
  -u, --update                                              Skip files that are newer on the destination
      ...
      --user-agent string                                   Set the user-agent to a specified string (default "zclone/v0.1.0-beta.10230.6a617a379.codex_zclone")
...
* [zclone archive](/commands/zclone_archive/)	 - Perform an action on an archive.
* [zclone authorize](/commands/zclone_authorize/)	 - Remote authorization.
* [zclone backend](/commands/zclone_backend/)	 - Run a backend-specific command.
* [zclone bisync](/commands/zclone_bisync/)	 - Perform bidirectional synchronization between two paths.
* [zclone cat](/commands/zclone_cat/)	 - Concatenates any files and sends them to stdout.
* [zclone check](/commands/zclone_check/)	 - Checks the files in the source and destination match.
* [zclone checksum](/commands/zclone_checksum/)	 - Checks the files in the destination against a SUM file.
...
* [zclone convmv](/commands/zclone_convmv/)	 - Convert file and directory names in place.
* [zclone copy](/commands/zclone_copy/)	 - Copy files from source to dest, skipping identical files.
* [zclone copyto](/commands/zclone_copyto/)	 - Copy files from source to dest, skipping identical files.
* [zclone copyurl](/commands/zclone_copyurl/)	 - Copy the contents of the URL supplied content to dest:path.
* [zclone cryptcheck](/commands/zclone_cryptcheck/)	 - Cryptcheck checks the integrity of an encrypted remote.
* [zclone cryptdecode](/commands/zclone_cryptdecode/)	 - Cryptdecode returns unencrypted file names.
* [zclone dedupe](/commands/zclone_dedupe/)	 - Interactively find duplicate filenames and delete/rename them.
* [zclone delete](/commands/zclone_delete/)	 - Remove the files in path.
* [zclone deletefile](/commands/zclone_deletefile/)	 - Remove a single file from remote.
* [zclone gendocs](/commands/zclone_gendocs/)	 - Output markdown docs for zclone to the directory supplied.
* [zclone gitannex](/commands/zclone_gitannex/)	 - Speaks with git-annex over stdin/stdout.
* [zclone gui](/commands/zclone_gui/)	 - Open the web based GUI.
* [zclone hashsum](/commands/zclone_hashsum/)	 - Produces a hashsum file for all the objects in the path.
* [zclone link](/commands/zclone_link/)	 - Generate public link to file/folder.
* [zclone listremotes](/commands/zclone_listremotes/)	 - List all the remotes in the config file and defined in environment variables.
* [zclone ls](/commands/zclone_ls/)	 - List the objects in the path with size and path.
* [zclone lsd](/commands/zclone_lsd/)	 - List all directories/containers/buckets in the path.
* [zclone lsf](/commands/zclone_lsf/)	 - List directories and objects in remote:path formatted for parsing.
* [zclone lsjson](/commands/zclone_lsjson/)	 - List directories and objects in the path in JSON format.
* [zclone lsl](/commands/zclone_lsl/)	 - List the objects in path with modification time, size and path.
* [zclone md5sum](/commands/zclone_md5sum/)	 - Produces an md5sum file for all the objects in the path.
...
* [zclone ncdu](/commands/zclone_ncdu/)	 - Explore a remote with a text based user interface.
* [zclone nfsmount](/commands/zclone_nfsmount/)	 - Mount the remote as file system on a mountpoint.
* [zclone obscure](/commands/zclone_obscure/)	 - Obscure password for use in the zclone config file.
* [zclone purge](/commands/zclone_purge/)	 - Remove the path and all of its contents.
* [zclone rc](/commands/zclone_rc/)	 - Run a command against a running zclone.
* [zclone rcat](/commands/zclone_rcat/)	 - Copies standard input to file on remote.
* [zclone rcd](/commands/zclone_rcd/)	 - Run zclone listening to remote control commands only.
* [zclone rmdir](/commands/zclone_rmdir/)	 - Remove the empty directory at path.
* [zclone rmdirs](/commands/zclone_rmdirs/)	 - Remove empty directories under the path.
* [zclone serve](/commands/zclone_serve/)	 - Serve a remote over a protocol.
* [zclone settier](/commands/zclone_settier/)	 - Changes storage class/tier of objects in remote.
* [zclone sha1sum](/commands/zclone_sha1sum/)	 - Produces an sha1sum file for all the objects in the path.
* [zclone size](/commands/zclone_size/)	 - Prints the total size and number of objects in remote:path.
...
* [zclone touch](/commands/zclone_touch/)	 - Create new file or change file modification time.
* [zclone tree](/commands/zclone_tree/)	 - List the contents of the remote in a tree like fashion.
