...
```
  ...
  -1, --resync                               Performs the resync run. Equivalent to --resync-mode path1. Consider using --verbose or --dry-run first.
      ...
      --workdir string                       Use custom working dir - useful for testing. (default: /var/folders/8n/pnkwx54j56l_j6l3zx2bqdb40000gp/T/tmp.Ix3gnniayL/Library/Caches/zclone/bisync)
```
