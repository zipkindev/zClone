---
title: "Drime"
description: "Zclone docs for Drime"
...
Here is a run through of `zclone config` to make a remote called `remote`.
...
- Config:      access_token
- Env Var:     ZCLONE_DRIME_ACCESS_TOKEN
- Type:        string
- Required:    false
...
- Env Var:     ZCLONE_DRIME_ROOT_FOLDER_ID
- Type:        string
- Required:    false
...
- Config:      workspace_id
- Env Var:     ZCLONE_DRIME_WORKSPACE_ID
- Type:        string
- Required:    false
...
- Config:      list_chunk
- Env Var:     ZCLONE_DRIME_LIST_CHUNK
- Type:        int
- Default:     1000
...
- Config:      hard_delete
- Env Var:     ZCLONE_DRIME_HARD_DELETE
- Type:        bool
- Default:     false
...
- Env Var:     ZCLONE_DRIME_UPLOAD_CUTOFF
- Type:        SizeSuffix
- Default:     5Mi
...
- Config:      chunk_size
- Env Var:     ZCLONE_DRIME_CHUNK_SIZE
- Type:        SizeSuffix
- Default:     5Mi
...
- Env Var:     ZCLONE_DRIME_UPLOAD_CONCURRENCY
- Type:        int
- Default:     4
...
- Config:      description
- Env Var:     ZCLONE_DRIME_DESCRIPTION
- Type:        string
- Required:    false
