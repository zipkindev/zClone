---
title: "Pixeldrain"
description: "Zclone docs for Pixeldrain"
...
and generate a new API key for zclone. Then run `zclone config` and use the API
...
zclone. For this you only need a directory ID. The directory ID can be found in
...
`zclone lsf Pixeldrain: --dirs-only -Fpi`

This will print directories in your `Pixeldrain` home directory and their public
IDs.

Enter this directory ID in the zclone config and you will be able to access the
directory.
...
- Config:      api_key
- Env Var:     ZCLONE_PIXELDRAIN_API_KEY
- Type:        string
- Required:    false
...
- Env Var:     ZCLONE_PIXELDRAIN_ROOT_FOLDER_ID
- Type:        string
- Default:     "me"
...
- Config:      api_url
- Env Var:     ZCLONE_PIXELDRAIN_API_URL
- Type:        string
...
- Config:      description
- Env Var:     ZCLONE_PIXELDRAIN_DESCRIPTION
- Type:        string
- Required:    false
