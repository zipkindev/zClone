...
var Assets = func() http.FileSystem {
	fs := vfsgen۰FS{
		...
		"/zclone-120x120.png": &vfsgen۰FileInfo{
			name:    "zclone-120x120.png",
			modTime: time.Date(2022, 10, 1, 4, 23, 36, 727914200, time.UTC),
		...
		"/zclone-48x48.png": &vfsgen۰FileInfo{
			name:    "zclone-48x48.png",
			modTime: time.Date(2022, 10, 1, 4, 23, 36, 727914200, time.UTC),
	...
	fs["/"].(*vfsgen۰DirInfo).entries = []os.FileInfo{
		...
		fs["/zclone-120x120.png"].(os.FileInfo),
		fs["/zclone-48x48.png"].(os.FileInfo),
