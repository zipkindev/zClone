...
It is designed to be used in a CI workflow or a local pre-commit hook.
...
- Reports violations in a CI-compatible error format.
...
def show_error(file_name, line, message):
    """
    Print an error message in a CI-compatible format.
    """
